...
namespace LogSentinel.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GDPRRegisterRecordDto :  IEquatable<GDPRRegisterRecordDto>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GDPRRegisterRecordDto" /> class.
        /// </summary>
        ...
        /// <param name="JointControllers">JointControllers.</param>
        ...
        /// <param name="SubProcessors">SubProcessors.</param>
        ...
        public GDPRRegisterRecordDto(string AuditTrailCorrelationKey = default(string), string Branch = default(string), GDPRResponsibleEntity Controller = default(GDPRResponsibleEntity), string ControllersDescription = default(string), DateTime? Created = default(DateTime?), List<DataRecipientCategoriesEnum> DataRecipientCategories = default(List<DataRecipientCategoriesEnum>), List<string> DataRecipientCategoriesOther = default(List<string>), DataSubjectCategoryEnum? DataSubjectCategory = default(DataSubjectCategoryEnum?), string DataSubjectCategoryOther = default(string), string Description = default(string), List<GDPRResponsibleEntity> JointControllers = default(List<GDPRResponsibleEntity>), string Notes = default(string), OrganizationRoleEnum? OrganizationRole = default(OrganizationRoleEnum?), PersonalDataCategoryEnum? PersonalDataCategory = default(PersonalDataCategoryEnum?), string PersonalDataCategoryOther = default(string), string PersonalDataFields = default(string), string ProcessOwner = default(string), string ProcessingActivityCode = default(string), string ProcessingActivityName = default(string), ProcessingLegalBasisEnum? ProcessingLegalBasis = default(ProcessingLegalBasisEnum?), GDPRResponsibleEntity Processor = default(GDPRResponsibleEntity), List<string> Purposes = default(List<string>), List<GDPRRecipient> Recipients = default(List<GDPRRecipient>), string RelevantDepartment = default(string), int? RetentionMonths = default(int?), string RiskDescription = default(string), SensitivePersonalDataCategoryEnum? SensitivePersonalDataCategory = default(SensitivePersonalDataCategoryEnum?), string Software = default(string), List<GDPRResponsibleEntity> SubProcessors = default(List<GDPRResponsibleEntity>), List<string> Tags = default(List<string>), List<TechnicalMeasuresEnum> TechnicalMeasures = default(List<TechnicalMeasuresEnum>), List<string> TechnicalMeasuresOther = default(List<string>), List<string> ThirdCountryTransferSafeguards = default(List<string>), List<string> ThirdCountryTransfers = default(List<string>), DateTime? Updated = default(DateTime?))
        {
        ...
        public GDPRResponsibleEntity Controller { get; set; }
        ...
        /// <summary>
        /// Gets or Sets JointControllers
        /// </summary>
        [DataMember(Name="jointControllers", EmitDefaultValue=false)]
        public List<GDPRResponsibleEntity> JointControllers { get; set; }
        ...
        public GDPRResponsibleEntity Processor { get; set; }
        ...
        /// <summary>
        /// Gets or Sets SubProcessors
        /// </summary>
        [DataMember(Name="subProcessors", EmitDefaultValue=false)]
        public List<GDPRResponsibleEntity> SubProcessors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  JointControllers: ").Append(JointControllers).Append("\n");
            ...
            sb.Append("  SubProcessors: ").Append(SubProcessors).Append("\n");
        ...
        {
            return this.Equals(input as GDPRRegisterRecordDto);
        }

        /// <summary>
        /// Returns true if GDPRRegisterRecordDto instances are equal
        /// </summary>
        /// <param name="input">Instance of GDPRRegisterRecordDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GDPRRegisterRecordDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.JointControllers == input.JointControllers ||
                    this.JointControllers != null &&
                    this.JointControllers.SequenceEqual(input.JointControllers)
                ) && 
                (
                ...
                (
                    this.SubProcessors == input.SubProcessors ||
                    this.SubProcessors != null &&
                    this.SubProcessors.SequenceEqual(input.SubProcessors)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JointControllers != null)
                    hashCode = hashCode * 59 + this.JointControllers.GetHashCode();
                if (this.Notes != null)
                ...
                if (this.SubProcessors != null)
                    hashCode = hashCode * 59 + this.SubProcessors.GetHashCode();
                if (this.Tags != null)
