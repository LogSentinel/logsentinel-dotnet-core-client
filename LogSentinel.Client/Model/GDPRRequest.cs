...
namespace LogSentinel.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GDPRRequest :  IEquatable<GDPRRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public GDPRRequest(string AdditionalDetails = default(string), string DataSubjectId = default(string), string DataSubjectName = default(string), long? Timestamp = default(long?))
        {
        ...
        {
            return this.Equals(input as GDPRRequest);
        }

        /// <summary>
        /// Returns true if GDPRRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GDPRRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GDPRRequest input)
        {
            if (input == null)
                return false;
