...
namespace LogSentinel.Client.Model
{
    ...
    public partial class Result :  IEquatable<Result>, IValidatableObject
    {
        ...
        public Result(string AdditionalDetails = default(string), string DataSubjectId = default(string), string DataSubjectName = default(string), string RequestEntryId = default(string), string _Result = default(string), long? Timestamp = default(long?))
        {
