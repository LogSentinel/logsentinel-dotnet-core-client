...
namespace LogSentinel.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WebAsyncTaskOfConsistencyProof :  IEquatable<WebAsyncTaskOfConsistencyProof>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebAsyncTaskOfConsistencyProof" /> class.
        /// </summary>
        /// <param name="callable">callable.</param>
        /// <param name="executor">executor.</param>
        /// <param name="timeout">timeout.</param>
        public WebAsyncTaskOfConsistencyProof(CallableOfobject callable = default(CallableOfobject), AsyncTaskExecutor executor = default(AsyncTaskExecutor), long? timeout = default(long?))
        {
        ...
        {
            return this.Equals(input as WebAsyncTaskOfConsistencyProof);
        }

        /// <summary>
        /// Returns true if WebAsyncTaskOfConsistencyProof instances are equal
        /// </summary>
        /// <param name="input">Instance of WebAsyncTaskOfConsistencyProof to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebAsyncTaskOfConsistencyProof input)
        {
            if (input == null)
                return false;
